...
import {
	...
	CreateReservationDtoSwagger,
	ExtendedCreateReservationSchema,
} from './dto/create-reservation.dto';
import {
	FindReservationsDto,
	FindReservationsDtoSwagger,
} from './dto/find-reservations.dto';
import {
	UpdateReservationDto,
	UpdateReservationMessageDto,
...
export class ReservationsController {
	...
	async findAll(
		@Query(new ZodPipe(FindReservationsDto)) query: FindReservationsDto
	) {
	...
	async update(
		@Param('id') id: string,
		@Body(new ZodPipe(UpdateReservationSchema))
