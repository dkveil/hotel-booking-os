...
import { CreateChargeDtoSwagger, CreateChargeSchema } from '@repo/backend';
import { z } from 'zod';
...
export const ExtendedCreateReservationSchema = CreateReservationSchema.and(
	AdditionalFieldsSchema
);

export type CreateReservationDto = z.infer<
	typeof ExtendedCreateReservationSchema
>;
