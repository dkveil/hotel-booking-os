		...
		<div className='space-y-8 p-6'>
			<div>
				<h2 className='text-2xl font-bold mb-4 text-gray-800'>
					Hotel Booking UI Components
				</h2>
				<p className='text-gray-600 mb-8'>
					A showcase of all available UI components from @repo/ui-web package.
				</p>
			</div>
			...
			<section>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
					<Card
						...
						className='block p-6 bg-blue-50 border border-blue-200 rounded-lg shadow hover:bg-blue-100 transition-colors'
					>
						Manage your hotel bookings, rooms, and guest information
						efficiently.
					</Card>
					<Card
						title='Room Booking'
						href='https://example.com/booking'
						className='block p-6 bg-green-50 border border-green-200 rounded-lg shadow hover:bg-green-100 transition-colors'
					>
					...
					<Card
						...
						className='block p-6 bg-purple-50 border border-purple-200 rounded-lg shadow hover:bg-purple-100 transition-colors'
					>
  ...
  return api.post("/bookings", { roomId, guestName });
					...
					<div>
						...
						<div className='flex flex-wrap gap-2'>
							<Code className='bg-green-50 border border-green-200 px-3 py-2 rounded font-mono text-sm text-green-800'>
								Booking confirmed
							</Code>
							<Code className='bg-red-50 border border-red-200 px-3 py-2 rounded font-mono text-sm text-red-800'>
								Error: Room not found
							</Code>
							<Code className='bg-yellow-50 border border-yellow-200 px-3 py-2 rounded font-mono text-sm text-yellow-800'>
								Processing...
							</Code>
						</div>
					</div>
